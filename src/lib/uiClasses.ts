...
/** Two-column split used on hero-adjacent sections — single centred column through tablet. */
export const splitGrid =
  'grid items-center gap-12 max-lg:justify-items-center max-lg:text-center lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:justify-items-stretch lg:text-left lg:gap-16 xl:gap-20'

export const splitGridReverse =
  'grid items-center gap-12 max-lg:justify-items-center max-lg:text-center lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:justify-items-stretch lg:text-left lg:gap-16 xl:gap-20'

/** Centre flex actions inside split sections on tablet. */
export const tabletActionsCenter = 'max-lg:[&_.flex]:justify-center max-lg:[&_.flex-wrap]:justify-center'
...
export const featureSectionLayout =
  'mt-12 grid w-full min-w-0 grid-cols-1 items-stretch gap-12 max-lg:justify-items-center md:mt-16 lg:mt-20 lg:grid-cols-2 lg:justify-items-stretch lg:gap-16'
