...
import { contentShell, sectionBandPadLoose, splitGrid, tabletActionsCenter } from '@/lib/uiClasses'
...
export function ContactCta({
  ...
  return (
    ...
    >
      <div className={`${contentShell} ${splitGrid} ${tabletActionsCenter}`}>
        <Reveal>
          <SectionHeading
            title={title}
          ...
          <IllustrationSlot
            ...
            tone="ink"
            className="mx-auto mt-8 aspect-[4/3] w-full max-w-[18rem] bg-meridian-soft/35 lg:mx-0"
          />
        </Reveal>
